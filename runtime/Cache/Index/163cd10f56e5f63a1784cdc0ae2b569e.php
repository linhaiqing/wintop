...
<body style="width: 100%">
    <div class="main_body">
        <div class="top_brand">
            <div class="t1"><img src="<?php echo ($config["site_url"]); echo ($product["big1"]); ?>" alt=""  ></div>
            <div class="t2">
            <a href="javacript:;" class="home" onclick="window.history.back();"><img src="<?php echo ($static_path); ?>images/back.png" alt=""></a>
            <div class="t22">
        ...
        <div class="brand_list">
            <div class="t3">
                <ul>
                    <li>
                        <img src="<?php echo ($config["site_url"]); echo ($product["big2"]); ?>" class="front" alt="">
                    </li>
                    <li style="margin-left: 40px">
                        <img src="<?php echo ($config["site_url"]); echo ($product["big3"]); ?>" class="front" alt="">
                    </li>
                </ul>
            </div>
            <div class="t4" >
                <h1><?php echo ($product["r_title"]); ?></h1>
                <h2><?php echo ($product["r_info"]); ?></h2>
            </div>
        </div>
    </div>
</body>
