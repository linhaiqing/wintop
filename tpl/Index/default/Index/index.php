...
<body>
    <div class="index_container">
        <div class="top_brand">
            <audio id="sound" autoplay="autoplay" loop="loop" src="{$static_path}music/music.mp3"></audio>
            <div id="play_icon" class="music_icon scroll"></div>
            <div class="aside_menu">
                <div class="aside_container">
                    <span class="aside_left"></span>
                    <span class="aside_bottom"></span>
                    <div class="wintop_logo"><img src="{$static_path}images/wintop_logo.jpg" alt=""></div>
                    <ul class="nav">
                        <li>
                            <a href="{:U('brand_profile')}" class="nav_item">
                                <h3>BRAND</h3>
                                <span>品牌介绍</span>
                            </a>
                        </li>
                        <li>
                            <a href="{:U('handicrafts')}" class="nav_item">
                                <h3 >HANDICRAFTS</h3>
                                <span>匠心手作</span>
                            </a>
                        </li>
                        <li>
                            <a href="{:U('products')}" class="nav_item">
                                <h3>PRODUCT</h3>
                                <span>产品介绍</span>
                            </a>
                        </li>
                        <li>
                            <a href="{:U('exhibition_profile')}" class="nav_item">
                                <h3>SHOW ROOM</h3>
                                <span>产品展厅</span>
                            </a>
                        </li>
                        <li>
                            <a href="{:U('partners')}" class="nav_item">
                                <h3>PARTNERS</h3>
                                <span>合作伙伴</span>
                            </a>
                        </li>
                        <li>
                            <a href="{:U('contactus')}" class="nav_item">
                                <h3>CONTACT</h3>
                                <span>联系我们</span>
                            </a>
                        </li>
            ...
            <img src="{$index_top_adver.0.pic}" alt="">
        </div>
